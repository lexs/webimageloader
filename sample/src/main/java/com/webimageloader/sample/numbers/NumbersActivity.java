...
public class NumbersActivity extends ListActivity {
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        Intent intent = new Intent(this, NumberDetailsActivity.class)
                .putExtra(NumberDetailsActivity.ARG_URL, url);
    ...
    private class Adapter extends BaseAdapter {
        ...
        public View getView(int position, View v, ViewGroup parent) {
            if (v == null) {
                v = inflater.inflate(R.layout.numbers_list_item, parent, false);
            }
